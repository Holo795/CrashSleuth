Pick the file for your system. Everything below is built by GitHub from this tag; `SHA256SUMS.txt` holds
...
Nothing leaves your computer unless you ask for it. See the wiki for what each screen does, and for the
few things that do reach the network (update check, share link, mappings download).
